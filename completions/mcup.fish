...
complete -c mcup -n "__fish_mcup_needs_command" -s r -l releases -d 'Selects released artifacts only' -r
complete -c mcup -n "__fish_mcup_needs_command" -s s -l snapshots -d 'Selects snapshot artifacts only' -r
...
complete -c mcup -n "__fish_mcup_using_subcommand keep" -s d -l dry-run -d 'Does not remove artifacts' -r
complete -c mcup -n "__fish_mcup_using_subcommand keep" -l list -d 'Prints the full path to the artifacts that will be removed' -r
...
complete -c mcup -n "__fish_mcup_using_subcommand rm" -s d -l dry-run -d 'Does not remove artifacts' -r
complete -c mcup -n "__fish_mcup_using_subcommand rm" -l list -d 'Prints the full path to the artifacts that will be removed' -r
